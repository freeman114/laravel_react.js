 ...
 */
//require('./bootstrap');
__webpack_require__(/*! ./rollbar */ "./resources/js/rollbar.js");

/***/ }),

/***/ "./resources/js/rollbar.js":
/*!*********************************!*\
  !*** ./resources/js/rollbar.js ***!
  \*********************************/
/*! no static exports found */
  ...
  function a(r, e) {
    if (r) {
      ...
      return n(function () {
        ...
        return e.enabled !== !1 && (void 0 === n || n === !0 || "object" == _typeof(n) && n.network) && r.addEventListener && (r.addEventListener("load", t.captureLoad.bind(t)), r.addEventListener("DOMContentLoaded", t.captureDomContentLoaded.bind(t))), r[o] = t, t;
      })();
    }
  }
  ...
  r.exports = function (r) {
    return function (e) {
      if (!e && !window._rollbarInitialized) {
        ...
        for (var o, n, t = r.globalAlias || "Rollbar", a = window.rollbar, l = function l(r) {
          return new a(r);
...
__webpack_require__(/*! F:\work\caresteps\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\work\caresteps\resources\sass\app.scss */"./resources/sass/app.scss");
